...
namespace EcoStationManagerApplication.Core.Interfaces
{
    public interface IStockOutService
    {
        ...
        Task<Result<List<StockOutDetail>>> GetStockOutDetailsByDateRangeAsync(DateTime startDate, DateTime endDate);
        Task<Result<StockOut>> CreateStockOutAsync(StockOut stockOut);
        Task<Result<List<StockOut>>> CreateMultipleStockOutsAsync(List<StockOut> stockOuts);
