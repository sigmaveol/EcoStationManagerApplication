...
namespace EcoStationManagerApplication.UI.Common
{
    public static class ThemeManager
    {
        ...
        public static void ApplyPanelTheme(Guna2Panel panel, bool isActive = true) 
        { 
            panel.FillColor = isActive ? PrimaryColor: SecondaryColor;
            ...
            panel.MouseLeave += (s, e) => { panel.FillColor = isActive ? PrimaryColor : SecondaryColor; };
